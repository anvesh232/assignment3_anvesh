...
2.
Found a "Simple Feedforward Neural Network".WOW gave me an accuracy of 87%.
3.
Found people in kaeggle using "Convolutional Neural Network model".Got an accuracy of 91.62.
4.
Found a "deeper Convolutional Neural Network model".
